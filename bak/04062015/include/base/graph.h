		...
		template <typename T> 
			class Graph : public Abstract {
				public:
					...
					Graph<T>(const Graph<T>& other): _m_graph(other._m_graph), 
													_m_is_directed(other._m_is_directed),
													_m_is_weighted(other._m_is_weighted),
													_m_weight(other._m_weight),
													_m_T_to_id(other._m_T_to_id),
													_m_id_to_T(other._m_id_to_T) {}
